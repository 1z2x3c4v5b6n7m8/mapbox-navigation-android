...
object MapboxRouteLineUtils {
     ...
     * @param deEmphasizeInactiveRouteLegs if true the traffic color of a route line section will be
     * overridden by the color option indicated in [RouteLineColorResources] for de-emphasizing
     * sections of a route which are not part of the active route leg.
     *
