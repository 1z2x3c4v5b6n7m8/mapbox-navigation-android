 ...
 * @param deEmphasizeInActiveRouteLegsColor the color used for route legs that aren't currently
 * being navigated.
 */
class RouteLineColorResources private constructor(
    ...
    @ColorInt val deEmphasizeInActiveRouteLegsColor: Int,
) {
    ...
    fun toBuilder(): Builder {
        return Builder()
            ...
            .deEmphasizeInActiveRouteLegsColor(deEmphasizeInActiveRouteLegsColor)
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (deEmphasizeInActiveRouteLegsColor != other.deEmphasizeInActiveRouteLegsColor)
            return false
    ...
    override fun hashCode(): Int {
        ...
        result = 31 * result + deEmphasizeInActiveRouteLegsColor
        return result
    }
    ...
    class Builder {
        ...
        private var deEmphasizeInActiveRouteLegsColor: Int =
         ...
         * @return the builder
         */
        fun deEmphasizeInActiveRouteLegsColor(@ColorInt color: Int): Builder =
            apply { this.deEmphasizeInActiveRouteLegsColor = color }
