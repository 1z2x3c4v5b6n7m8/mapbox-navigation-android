...
class RouteLineColorResourcesTest :
    ...
    override fun getFilledUpBuilder(): RouteLineColorResources.Builder {
        return RouteLineColorResources.Builder()
            ...
            .deEmphasizeInActiveRouteLegsColor(21)
    }
    ...
    @Test
    fun deEmphasizeInActiveRouteLegsColor() {
        val resources =
            RouteLineColorResources.Builder().deEmphasizeInActiveRouteLegsColor(5).build()

        assertEquals(5, resources.deEmphasizeInActiveRouteLegsColor)
    }
    ...
    fun toBuilder() {
        ...
        assertEquals(21, result.deEmphasizeInActiveRouteLegsColor)
    }
}
