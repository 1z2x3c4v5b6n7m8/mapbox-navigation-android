...
class MultiLegRouteExampleActivity : AppCompatActivity() {
    ...
    private val routeColorResources: RouteLineColorResources by lazy {
        ...
        RouteLineColorResources.Builder().deEmphasizeInActiveRouteLegsColor(Color.GRAY).build()
    }
    ...
    private val options: MapboxRouteLineOptions by lazy {
        MapboxRouteLineOptions.Builder(this)
            ...
            .deEmphasizeInactiveRouteLegs(true) // This is the relevant option for this example
    ...
    private val routeProgressObserver = RouteProgressObserver { routeProgress ->
        ...
        // It's important to note that the code snippet below should only be used if the
        // MapboxRouteLineOptions::withVanishingRouteLineEnabled is set to false, which is the
        // default. If you want to use the de-emphasize route in active route leg feature
        // with the vanishing route line feature follow the instructions for using the vanishing
        // route line and enable MapboxRouteLineOptions::deEmphasizeInactiveRouteLegs but do
        // NOT use the MapboxRouteLineApi::showOnlyActiveLeg method.
        routeLineApi.showOnlyActiveLeg(routeProgress) {
            mapboxMap.getStyle()?.let { style ->
                routeLineView.renderVanishingRouteLineUpdateValue(style, it)
            }
        }
