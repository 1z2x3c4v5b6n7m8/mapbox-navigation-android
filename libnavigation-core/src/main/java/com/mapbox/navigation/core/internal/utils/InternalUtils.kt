...
object InternalUtils {
    ...
    internal var LOOK_AHEAD_MILLISECONDS = 1000L
    ...
    /**
     * Internal API used for testing. Sets the static look ahead value for all
     ...
     */
    fun setLookAhead(lookAheadInMillis: Long?) {
        LOOK_AHEAD_MILLISECONDS = lookAheadInMillis ?: 1000L
    }
